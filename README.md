...
Demo Scope
The demo version of Steady focuses on Uber and Uber Eats workers. It uses simulated data modeled on real Uber trip and weekly earnings structures to show:
Weekly income forecasts and volatility visualization


Personalized behavioral insights based on trip-level patterns


How contextual data (e.g., rain, public holidays) influences weekly earnings


While the driver data is simulated due to API access limitations, all contextual data in the demo is drawn from real, publicly available sources. In production, Steady would replace simulated driver data with authenticated inputs from Uber’s Driver API 
Future Vision
